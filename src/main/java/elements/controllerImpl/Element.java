...
public class Element implements IElement {
    ...
    public void slide(int offset)
    {
        ...
        js.executeScript("arguments[0].setAttribute('style', 'width: "+offset+"%;')",element);

    }

    @Override
    public void slideAndClick()
    {
        Actions builder = new Actions(Driver.getInstance().getDriver());

        org.openqa.selenium.interactions.Action dragAndDrop =

        builder.clickAndHold(element).moveByOffset(40,0).release().build();
